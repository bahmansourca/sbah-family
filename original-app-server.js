...
const PORT = 5500; // Port différent pour éviter les conflits
...
// Serveur HTTP pour l'application originale
const server = http.createServer((req, res) => {
  ...
  fs.readFile(filePath, (err, content) => {
    if (err) {
      ...
      // Configuration des en-têtes sans cache pour forcer le rechargement
      res.writeHead(200, { 
...
server.listen(PORT, () => {
  ...
  console.log(`======================================================`);
  console.log(`APPLICATION SBAH FAMILY ORIGINALE`);
